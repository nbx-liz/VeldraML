                                ...
                                [
                                    ...
                                    dbc.InputGroup(
                                        [
                                            ...
                                            dbc.Button("Refresh", id="artifact-refresh-btn", color="secondary"),
                                        ]
                                    ),
                                ],
                                width=4
                            ...
                            dbc.Col(
                                dbc.Row(
                                    [
                                        dbc.Col(
                                            [
                                                html.Label("Select Artifact", className="fw-bold mb-2"),
                                                dbc.Select(
                                                    id="artifact-select",
                                        ...
                                        dbc.Col(
                                            [
                                                html.Label("Compare With (Optional)", className="fw-bold mb-2"),
                                                dbc.Select(
                            ...
                            [
                                dbc.Col(
                                    [
                                        dbc.Tabs(
                                            [
                                                dbc.Tab(
                                                    dcc.Graph(id="result-chart-main", style={"height": "400px"}),
                                                    label="Primary Chart",
                                                    tab_id="tab-chart-main"
                                                ),
                                                dbc.Tab(
                                                    dcc.Graph(id="result-chart-secondary", style={"height": "400px"}),
                                ...
                                dbc.Col(
                                    [
                                        ...
                                        dbc.Button("Re-evaluate", id="artifact-evaluate-btn", color="primary", className="w-100 mb-3"),
                                        
                                        html.Label("Evaluation Data Path", className="small text-muted"),
                                        dbc.Input(id="artifact-eval-data-path", placeholder="path/to/data.csv", className="mb-3"),
