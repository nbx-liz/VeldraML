        ...
        [
                        ...
                        html.Div(
                            [
                                html.Div(
                                    [
                                        html.Label(
                                            "Causal Analysis", className="me-2 fw-bold text-warning"
                                        ),
                                        dbc.Switch(
                                            id="cfg-causal-enabled",
                                            value=False,
                                            label="Enable DR / DR-DiD",
                                        ),
                                    ],
            ...
            dbc.Card(
                dbc.CardBody(
                    [
                        dbc.Row(
                            [
                                dbc.Col(
                                    [
                                        html.Label(
                                            "Data Path (from Data Page)",
                                            className="small text-muted",
                                        ),
                                        dbc.Input(
                                            id="cfg-data-path", disabled=True, className="mb-2"
                                        ),
                                    ],
                                    width=6,
                                ),
                        ...
                        html.Div(
                            dbc.Checklist(
                                id="cfg-data-drop-cols", options=[], value=[], inline=False
                            ),
                    ...
                    [
                        ...
                        html.Div(
                            [
                                ...
                                dbc.Select(
                                    id="cfg-split-group-col", placeholder="Select group column..."
                                ),
                            ],
                            ...
                            [
                                ...
                                dbc.Row(
                                    [
                                        dbc.Col(
                                            [
                                                html.Label("Test Size (steps)"),
                                                dbc.Input(id="cfg-split-test-size", type="number"),
                                            ],
                                            width=4,
                                        ),
                                        dbc.Col(
                                            [
                                                html.Label("Gap"),
                                                dbc.Input(
                                                    id="cfg-split-gap", type="number", value=0
                                                ),
                                            ],
                                            width=4,
                                        ),
                                        dbc.Col(
                                            [
                                                html.Label("Embargo"),
                                                dbc.Input(
                                                    id="cfg-split-embargo", type="number", value=0
                                                ),
                                            ],
                                            width=4,
                                        ),
                            ...
                            [
                                ...
                                dbc.Col(
                                    [
                                        ...
                                        dbc.Input(
                                            id="cfg-train-num-leaves", type="number", value=31
                                        ),
                                    ],
                                    width=3,
                                ),
                            ...
                            [
                                dbc.AccordionItem(
                                    [
                                        ...
                                        dcc.Slider(
                                            id="cfg-train-subsample",
                                            min=0.1,
                                            max=1.0,
                                            step=0.1,
                                            value=1.0,
                                            marks={0.5: "0.5", 1.0: "1.0"},
                                        ),
                                        html.Label("Colsample By Tree", className="mt-3"),
                                        dcc.Slider(
                                            id="cfg-train-colsample",
                                            min=0.1,
                                            max=1.0,
                                            step=0.1,
                                            value=1.0,
                                        ...
                                        dbc.Row(
                                            [
                                                ...
                                                dbc.Col(
                                                    [
                                                        html.Label("Reg Lambda"),
                                                        dbc.Input(
                                                            id="cfg-train-reg-lambda",
                                                            type="number",
                                                            value=0,
                                                        ),
                                                    ],
                                    ...
                                    [
                                        ...
                                        dbc.Col(
                                            [
                                                html.Label("N Trials"),
                                                dbc.Input(
                                                    id="cfg-tune-trials", type="number", value=30
                                                ),
                                            ],
                                            width=3,
                                        ),
                                        dbc.Col(
                                            [
                                                ...
                                                dbc.Select(
                                                    id="cfg-tune-objective", placeholder="Auto"
                                                ),
                                            ],
                                            width=3,
                                        ),
                        ...
                        dbc.Accordion(
                            [
                                dbc.AccordionItem(
                                    [
                                        html.P(
                                            "Override default search ranges for Optuna.",
                                        ...
                                        dbc.Row(
                                            [
                                                ...
                                                dbc.Col(
                                                    [
                                                        html.Label("Leaves Min"),
                                                        dbc.Input(
                                                            id="cfg-tune-leaves-min",
                                                            placeholder="16",
                                                            type="number",
                                                        ),
                                                    ],
                                                ...
                                                dbc.Col(
                                                    [
                                                        html.Label("Leaves Max"),
                                                        dbc.Input(
                                                            id="cfg-tune-leaves-max",
                                                            placeholder="255",
                                                            type="number",
                                                        ),
                                                    ],
                                        ...
                                        dbc.Row(
                                            [
                                                ...
                                                dbc.Col(
                                                    [
                                                        html.Label("Depth Max"),
                                                        dbc.Input(
                                                            id="cfg-tune-depth-max",
                                                            placeholder="15",
                                                            type="number",
                                                        ),
                                                    ],
            ...
            html.Div(
                [
                    ...
                    dbc.Button(
                        "Back to Top",
                        id="config-back-top-btn",
                        color="secondary",
                        outline=True,
                        href="#cfg-builder-top",
                        className="w-100",
                    ),
                ],
                className="mt-4 mb-5",
                                ...
                                [
                                    html.Div(
                                        [
                                            ...
                                            html.Label(
                                                "Generated RunConfig YAML", className="fw-bold mb-2"
                                            ),
                                            dcc.Textarea(
                                                id="config-yaml",
