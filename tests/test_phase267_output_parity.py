...
_BASELINE_DIR = Path("tests/fixtures/phase267_parity")
...
def test_phase267_parity_regression() -> None:
    ...
    assert out.training_history == expected["training_history"]
...
def test_phase267_parity_binary() -> None:
...
def test_phase267_parity_multiclass() -> None:
...
def test_phase267_parity_frontier() -> None:
